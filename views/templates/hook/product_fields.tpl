<div id="dynamic-price-calculator" class="product-custom-fields box-info-product">
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            <label for="dp_width">{l s='Width (mm)' d='Modules.Dynamicprice.Shop'}</label>
            <input type="number" name="dp_width" id="dp_width" class="form-control dp-calc-field" value="100" min="1">
        </div>
        <div class="col-md-6 form-group">
            <label for="dp_height">{l s='Height (mm)' d='Modules.Dynamicprice.Shop'}</label>
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-6 form-group">
            <label for="dp_density">{l s='Infill Density (%)' d='Modules.Dynamicprice.Shop'}</label>
